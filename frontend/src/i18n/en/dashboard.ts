...
export default {
  ...
  'oss_title': 'Object Storage (Aliyun OSS)',
  'oss_desc': 'Some third-party video providers (e.g. TecDo) require images as public URLs. Once configured, local storyboard images are uploaded to this OSS and served via temporary signed URLs.',
  'oss_endpoint': 'Endpoint',
  'oss_bucket': 'Bucket',
  'oss_access_key_id': 'AccessKey ID',
  'oss_access_key_secret': 'AccessKey Secret',
  'oss_upload_prefix': 'Upload prefix (optional)',
  'oss_secret_placeholder': 'Enter AccessKey Secret',
  'asset_cache_title': 'Provider asset cache',
  'asset_cache_desc': 'Some third-party video providers (e.g. TecDo) require reference images to be registered as platform assets before generation. Asset IDs are cached by image content for reuse, avoiding repeated registration.',
  'asset_cache_mode_label': 'Cache mode',
  'asset_cache_mode_cached': 'Reuse cache (recommended)',
  'asset_cache_mode_recreate': 'Recreate every time',
  'asset_cache_mode_cached_hint': 'Reuse registered assets by image content hash, skipping repeated upload and review.',
  'asset_cache_mode_recreate_hint': 'Re-register the asset on every generation to avoid "asset not found" failures from expired upstream assets, at the cost of speed and quota.',
  'clear_asset_cache': 'Clear cache',
  'clear_asset_cache_hint': 'Delete all cached provider asset IDs; the next generation will re-register them. Clear manually when upstream assets expire.',
  'asset_cache_cleared': 'Cleared {{count}} cached asset(s)',
  ...
  'media_regenerate_confirm_title': 'Regenerate?',
  'media_regenerate_confirm_desc': 'This shot already has a generated result. Regenerating will overwrite it and consume quota. Continue?',
  'media_regenerate_confirm': 'Regenerate',
