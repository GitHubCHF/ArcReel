...
export default {
  ...
  'oss_title': 'Lưu trữ đối tượng (Aliyun OSS)',
  'oss_desc': 'Một số nhà cung cấp video bên thứ ba (ví dụ TecDo) yêu cầu ảnh ở dạng URL công khai. Sau khi cấu hình, ảnh storyboard cục bộ sẽ được tải lên OSS này và phục vụ qua URL ký tạm thời.',
  'oss_endpoint': 'Endpoint',
  'oss_bucket': 'Bucket',
  'oss_access_key_id': 'AccessKey ID',
  'oss_access_key_secret': 'AccessKey Secret',
  'oss_upload_prefix': 'Tiền tố thư mục tải lên (tùy chọn)',
  'oss_secret_placeholder': 'Nhập AccessKey Secret',
  'asset_cache_title': 'Bộ nhớ đệm tài nguyên nhà cung cấp',
  'asset_cache_desc': 'Một số nhà cung cấp video bên thứ ba (như TecDo) yêu cầu đăng ký ảnh tham chiếu thành tài nguyên nền tảng trước khi tạo video. Hệ thống lưu ID tài nguyên theo nội dung ảnh để tái sử dụng, tránh đăng ký lặp lại.',
  'asset_cache_mode_label': 'Chế độ bộ nhớ đệm',
  'asset_cache_mode_cached': 'Tái sử dụng bộ nhớ đệm (khuyến nghị)',
  'asset_cache_mode_recreate': 'Tạo lại mỗi lần',
  'asset_cache_mode_cached_hint': 'Tái sử dụng tài nguyên đã đăng ký theo hash nội dung ảnh, bỏ qua việc tải lên và duyệt lặp lại.',
  'asset_cache_mode_recreate_hint': 'Đăng ký lại tài nguyên mỗi lần tạo để tránh lỗi "asset not found" do tài nguyên thượng nguồn hết hạn, nhưng chậm hơn và tốn hạn mức hơn.',
  'clear_asset_cache': 'Xóa bộ nhớ đệm',
  'clear_asset_cache_hint': 'Xóa tất cả ID tài nguyên nhà cung cấp đã lưu; lần tạo tiếp theo sẽ đăng ký lại. Xóa thủ công khi tài nguyên thượng nguồn hết hạn.',
  'asset_cache_cleared': 'Đã xóa {{count}} tài nguyên trong bộ nhớ đệm',
  ...
  'media_regenerate_confirm_title': 'Tạo lại?',
  'media_regenerate_confirm_desc': 'Cảnh này đã có kết quả. Tạo lại sẽ ghi đè nội dung hiện tại và tiêu tốn hạn mức. Tiếp tục?',
  'media_regenerate_confirm': 'Tạo lại',
