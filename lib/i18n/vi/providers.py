...
MESSAGES: dict[str, str] = {
    ...
    "provider_desc_runninghub": "API mô hình tiêu chuẩn RunningHub, tích hợp tạo video Seedance 2.0 của ByteDance (text-/image-/reference-to-video). Chỉ hỗ trợ video.",
    "provider_desc_tecdo": "API nền tảng năng lực TecDo, tích hợp tạo video Seedance 2.0 của ByteDance (text-/image-/reference-to-video). Chỉ hỗ trợ video.",
