...
export default {
  ...
  'oss_title': '对象存储 (阿里云 OSS)',
  'oss_desc': '部分第三方视频供应商（如钛动）要求图片为公网 URL。配置后，本地分镜图会上传到此 OSS 并以临时签名 URL 提供。',
  'oss_endpoint': 'Endpoint',
  'oss_bucket': 'Bucket',
  'oss_access_key_id': 'AccessKey ID',
  'oss_access_key_secret': 'AccessKey Secret',
  'oss_upload_prefix': '上传目录前缀（可选）',
  'oss_secret_placeholder': '请输入 AccessKey Secret',
  'asset_cache_title': '供应商资产缓存',
  'asset_cache_desc': '部分第三方视频供应商（如钛动）要求先把参考图登记为平台资产再生成视频。系统会按图片内容缓存资产 ID 复用，避免重复登记。',
  'asset_cache_mode_label': '缓存模式',
  'asset_cache_mode_cached': '复用缓存（推荐）',
  'asset_cache_mode_recreate': '每次重新生成',
  'asset_cache_mode_cached_hint': '按图片内容哈希复用已登记的资产，省去重复上传与过审。',
  'asset_cache_mode_recreate_hint': '每次生成都重新登记资产，规避上游资产过期导致的「asset not found」失败，但更慢、更耗配额。',
  'clear_asset_cache': '清空缓存',
  'clear_asset_cache_hint': '删除所有已缓存的供应商资产 ID，下次生成将重新登记。上游资产失效报错时可手动清空。',
  'asset_cache_cleared': '已清空 {{count}} 条资产缓存',
  'usage_stats': '用量统计',
  ...
  'media_regenerate_confirm_title': '重新生成？',
  'media_regenerate_confirm_desc': '该镜头已有生成结果，重新生成会覆盖当前内容并消耗额度。确认继续？',
  'media_regenerate_confirm': '确认重新生成',
